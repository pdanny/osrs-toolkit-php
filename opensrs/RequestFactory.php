...
class RequestFactory
{
    public static $RequestRoutes = array(
        ...
        'trustswregister' => 'trust\SWRegister',
        'trustcancelfreetrial' => 'trust\CancelFreeTrial',
        'trustcancelorder' => 'trust\CancelOrder',
        'trustcreatetoken' => 'trust\CreateToken',
        'trustdvauthondemandcheck' => 'trust\DVAuthOnDemandCheck',
        'trustgetcert' => 'trust\GetCert',
        'trustgetproductinfo' => 'trust\GetProductInfo',
        'trustgetproducts' => 'trust\GetProducts',
        ...
        'trustresendapproveemail' => 'trust\ResendApproveEmail',
